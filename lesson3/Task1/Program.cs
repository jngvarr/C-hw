// Напишите программу, которая принимает на вход координаты точки (X и Y), причём X ≠ 0 или Y ≠ 0 и выдаёт номер 
...
bool ValidateCoord(int x, int y)
{
    if (x == 0 || y == 0)
    {
        System.Console.Write("Точка находится на одной из координатных осей ");
        return false;
    }
    return true;
}
